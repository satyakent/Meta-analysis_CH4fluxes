...
best_ntrees <- gbm.perf(gbm_model_cv, method = "cv", plot.it = TRUE) #here the best # of trees is 4327
print(best_ntrees)
...
gbm_model_cv <- gbm(
  ...
  interaction.depth = 3, #Elith 2008 recommends values of 2 or 3 for small sample sizes (<250)
  shrinkage = 0.004, #what papers recommend for small sample sizes (Elith 2008; Ridgeway 2024), increased here from 0.001 for better model fit
  #smaller values increase model performance 
  n.minobsinnode = 10, 
  cv.folds = cv_folds, #5-fold cv
  verbose = TRUE
